...
//    */
//   it('Check to make sure "Save" button should redirect to the note view mode window',
//    async () => {
//     console.log('Checking "Save" button...');
//     const newButton = await page.$('#save-button');
//     await newButton.click();
//     const alertWindow = await page.evaluate('window.confirm = () => true');
...
//    */
//   it('Check to make sure the title input is changed from "Untitled Note" to "Lecture 1 CSE 110"',
//    async () => {
//     console.log(
